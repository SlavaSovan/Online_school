...
<script>
import MentorLessonBlock from './MentorLessonBlock.vue'

export default {
    name: 'MentorModuleBlock',
    components: { MentorLessonBlock },
    props: {
        module: {
            type: Object,
            required: true
